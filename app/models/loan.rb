...
class Loan < ActiveRecord::Base
  ...
  # TODO: I think this may be over-abstraction ~Fuzzy
  %i(criteria post_analysis).each do |kind|
    has_one kind, -> { where("loan_response_sets.kind" => kind.to_s) }, class_name: "LoanResponseSet"
  end
