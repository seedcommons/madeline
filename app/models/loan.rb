...
class Loan < ActiveRecord::Base
  ...
  #todo: confirm if symbol constants make sense, or better to either use strings or just document usages in case of a need to rename
  LOAN_CRITERIA_FIELD_SET_SYMBOL = :loan_criteria
  POST_ANALYSIS_FIELD_SET_SYMBOL = :loan_post_analysis
  ...
  attr_custom_model_linkable LOAN_CRITERIA_FIELD_SET_SYMBOL, POST_ANALYSIS_FIELD_SET_SYMBOL
