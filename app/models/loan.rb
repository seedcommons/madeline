...
class Loan < Project
  ...
  attr_option_settable :status, :loan_type, :public_level, :source_of_capital

  validates :organization, :public_level_value, presence: true
  validates :source_of_capital_value, :inclusion => {:in => Loan.source_of_capital_option_values}
  ...
  def source_of_capital
    source_of_capital_label
  end
