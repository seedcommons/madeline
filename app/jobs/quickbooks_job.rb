...
class QuickbooksJob < TaskJob
  rescue_from(Accounting::QB::NotConnectedError) do |error|
    Accounting::LoanIssue.create!(level: :warning, message: :quickbooks_not_connected)
  ...
  rescue_from(Quickbooks::ServiceUnavailable) do |error|
    Accounting::LoanIssue.create!(level: :warning, message: :quickbooks_unavailable_fetch)
  ...
  rescue_from(StandardError) do |error|
    Accounting::LoanIssue.create!(level: :warning, message: :system_error_fetch)
