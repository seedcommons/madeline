class Admin::Accounting::QuickbooksController < Admin::AdminController
  ...
  def oauth_callback
    ...
    Accounting::Quickbooks::Connection.create_from_access_token(access_token: qb_access_token,
      division: Division.root, params: params)
  ...
  def qb_access_token
    qb_consumer.verify_access_token(qb_request_token: Marshal.load(session[:qb_request_token]),
