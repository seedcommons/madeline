...
feature 'timeline batch actions', js: true do
  ...
  let(:step1) { create(:project_step, project: loan, scheduled_start_date: Date.today) }
  ...
  let!(:step1_orig_date) { step1.scheduled_start_date }
  let!(:step2_orig_date) { step2.scheduled_start_date }
  let!(:step3_orig_date) { step3.scheduled_start_date }
  let!(:step4_orig_date) { step4.scheduled_start_date }
  let!(:step5_orig_date) { step5.scheduled_start_date }
