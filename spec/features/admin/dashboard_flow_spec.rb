...
feature 'dashboard flow' do
  ...
  describe "assigned steps" do
    ...
    scenario "show assigned steps" do
      ...
      step2 = create(:project_step, agent: @person, project: @loan1, scheduled_start_date: Date.today - 1.month, is_finalized: true, actual_end_date: nil)
      ...
      expect(page).to have_content(step2.summary)
